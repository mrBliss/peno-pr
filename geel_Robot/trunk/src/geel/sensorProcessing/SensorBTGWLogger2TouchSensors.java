 ...
 *
 */
public class SensorBTGWLogger2TouchSensors {
	...
	private TouchSensor touchSensorFrontLeft;
	private TouchSensor touchSensorFrontRight;
	

	public SensorBTGWLogger2TouchSensors(LightSensorReader lightSensorReader,
		...
		this.touchSensorFrontLeft = touchSensorFrontLeft;
		this.touchSensorFrontRight = touchSensorFrontRight;
	}
	...
	private synchronized void sendStatusUpdate(){
		...
		if(	this.updatedColor && 
			...
			BTGWPacketStatusUpdate p = new BTGWPacketStatusUpdate(this.color, 
					...
					this.touchSensorFrontLeft.isPressed()||this.touchSensorFrontRight.isPressed());
